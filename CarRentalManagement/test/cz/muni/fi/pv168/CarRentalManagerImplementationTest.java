...
import static cz.muni.fi.pv168.CarManagerImplementationTest.*;
import static cz.muni.fi.pv168.CustomerManagerImplementationTest.*;

/**
 *
 * @author Jooji
 */
public class CarRentalManagerImplementationTest {
    
    private CarManagerImplementation carManager;
    private CustomerManagerImplementation customerManager;
    private CarRentalManagerImplementation manager;
    ...
    public void setUp() throws SQLException
    {
        ...
        manager = new CarRentalManagerImplementation();
    ...
    public void findCustomerWithCar()
    {
        ...
        assertTrue(car2.getStatus());
        assertTrue(car3.getStatus());
    ...
    public void getAllCustomerCars()
    {
        ...
        assertFalse(customer3.isActive());
    ...
    private static CarInventory newCarInventory(long carId, long customerId, Date rentDate, Date dueDate)
    {
